...
void printUsage() {
    ...
    qDebug()<<"Usage:\n"
           <<"st_pattern seg dataset_dir dataset_suffix output segmentation_step use_temporal min_seg_length use_SEST dotsTh\n"
          <<"e.g.: st_pattern seg path_to_mopsi .txt mopsi_100 1.6 1 100.0 1 1000\n\n"
